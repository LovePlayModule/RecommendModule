...
- (void)loadTopicData
{
    [[HttpRequest sharedInstance] GET:@"/news/topicOrderSource/list" parameters:nil success:^(id response) {
...
{
    [[HttpRequest sharedInstance] GET:@"/news/config/config_focus_img/list/" parameters:nil success:^(id response) {
...
//                newsDetailViewController.newsID = imageInfoModel.docid;
                UIViewController *viewController = [[Mediator sharedInstance] NewsDetail_viewControllerWithNewsID:imageInfoModel.docid];
